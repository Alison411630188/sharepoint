    ...
    <footer className="bg-slate-900 text-white py-12">
      <div className="container grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="md:col-span-1">
          <Link href="/" onClick={handleLinkClick} className="flex items-center gap-2 font-bold text-xl mb-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-slate-400">
            <li>
              <Link href="/basics/what-is-sharepoint" onClick={handleLinkClick} className="hover:text-primary transition">
                SharePoint 是什麼
              </Link>
            </li>
            <li>
              <Link href="/tutorials/operation-guide" onClick={handleLinkClick} className="hover:text-primary transition">
                網站架構
              </Link>
            </li>
            <li>
              <Link href="/hub-site" onClick={handleLinkClick} className="hover:text-primary transition">
                中樞網站
              </Link>
            </li>
            <li>
              <Link href="/scenarios/use-cases" onClick={handleLinkClick} className="hover:text-primary transition">
                核心內容
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-slate-400">
            <li>
              <Link href="/support/faq" onClick={handleLinkClick} className="hover:text-primary transition">
                常見問題
              </Link>
            </li>
            <li>
              <Link href="/support/contact" onClick={handleLinkClick} className="hover:text-primary transition">
                聯絡我們
              </Link>
            </li>
          </ul>
